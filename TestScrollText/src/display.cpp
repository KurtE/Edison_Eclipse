...
//=============================================================================================================
inline void  TFTDisplayObject::Enable(boolean fEnabled) {
  _fEnabled = fEnabled;
}
...
//=============================================================================================================
TFTButton::TFTButton(uint16_t x, uint16_t y, uint16_t dx, uint16_t dy, uint16_t wBtnClr, uint16_t wHiClr, uint16_t wTextClr, std::string str, uint16_t wVal)  {
...
void SCROLLTEXT::AddTextLine(unsigned char *psz) {
	...
	tft.setTextSize(2);
	tft.fillRect(_x+1, _y+_h-18, _w-2, 16, ILI9341_BLACK);
	tft.setCursor(_x+1,_y+_h-18);
	tft.print((char*)psz);
}
